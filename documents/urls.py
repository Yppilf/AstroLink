...
urlpatterns = [
    ...
    path("<int:doc_id>/sign/<int:field_id>/",signing_views.sign_generated_document,name="sign_generated_document"),
     path('<int:doc_id>/view/', generate_views.generated_document_view, name='generated_document_view'),
]